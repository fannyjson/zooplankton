...
smhi_data_common=read.delim("C:/Users/johan/OneDrive/R/Master project/smhi_data_common_samples_silva_240516.tsv")
#pr2_taxa_common=read.delim("C:/Users/johan/OneDrive/R/Master project/metabar_df_common_samples_PR2_240411.tsv")
pr2_taxa_common=read.delim("C:/Users/johan/OneDrive/R/Master project/metabar_df_common_samples_PR2_240511.tsv")
...
total_unique_silva = sapply(unique_silva, function(x) length(unique(x)))  # Corrected to sapply
